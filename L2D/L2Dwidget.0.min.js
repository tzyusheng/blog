...
webpackJsonpL2Dwidget([0], {
  79: function (t, e, i) {
    ...
    function L(t) {
      ...
      var e = n.currCanvas.getBoundingClientRect(),
        ...
        r = D(t.clientY - e.top),
        o = S(
          { x: e.left + e.width / 2, y: e.top + e.height * v },
          { x: t.clientX, y: t.clientY },
          e,
        ),
        s = A(o.x - e.left),
        a = w(o.y - e.top);
      l.cDefine.DEBUG_MOUSE_LOG &&
        console.log(
    ...
    (e.theRealInit = function () {
      ...
      (d = new a.L2DViewMatrix()).setScreenRect($, P, v, S),
        d.setMaxScreenRect(
          l.cDefine.VIEW_LOGICAL_MAX_LEFT,
          l.cDefine.VIEW_LOGICAL_MAX_RIGHT,
          l.cDefine.VIEW_LOGICAL_MAX_BOTTOM,
          l.cDefine.VIEW_LOGICAL_MAX_TOP,
        ),
        (t =
          (u.default.mobile() && o.config.mobile.scale) ||
          o.config.model.scale),
        d.adjustScale(0, 0, t),
  ...
  80: function (t, e, i) {
    ...
    (function (t) {
      ...
      (r._$0s = 1),
        ...
        (r.prototype.multParamFloat = function (t, e, i) {
          "number" != typeof t && (t = this._$5S.getParamIndex(l.getID(t))),
            ...
            this._$5S.setParamFloat(
              t,
              this._$5S.getParamFloat(t) * (1 + (e - 1) * i),
            );
        }),
        ...
        (r.prototype.getIndexArray = function (t) {
          ...
          return null != e && e.getType() == W._$wb && e instanceof lt
            ? e.getIndexArray()
            : null;
        }),
        (o.CHANNEL_COUNT = 4),
        ...
        (s.prototype.updateParam = function (t, e) {
          if (e._$AT && !e._$9L) {
            ...
            (0 <=
              (o =
                o *
                (0 == this._$dP ? 1 : _t._$r2((i - e._$bs) / this._$dP)) *
                (0 == this._$eo || e._$Do < 0
                  ? 1
                  : _t._$r2((e._$Do - i) / this._$eo))) &&
              o <= 1) ||
              console.log("### assert!! ### "),
      ...
      (T._$ni = function (t, e, i, r, o, n, s, a, _) {
        ...
        (v._$Vr = function (t, e, i, r, o, n, s, a) {
          ...
          if (_ <= 0) {
            ...
            for (
              var Et = 1 << _, Mt = new Float32Array(Et), xt = 0;
              xt < Et;
              xt++
            ) {
              for (var At = xt, wt = 1, It = 0; It < _; It++)
                (wt *= At % 2 == 0 ? 1 - l[It] : l[It]), (At /= 2);
              Mt[xt] = wt;
            }
            ...
            for (c = 0; c < $; ) {
              var bt = 0,
                ...
                Ft = c + 1;
              for (Ot = 0; Ot < Et; Ot++)
                (bt += Mt[Ot] * Dt[Ot][c]), (Rt += Mt[Ot] * Dt[Ot][Ft]);
        ...
        (x.prototype.interpolateOpacity = function (t, e, i, r) {
          null == this._$mS
            ...
            : i.setInterpolatedOpacity(v._$br(t, e, r, this._$mS));
        }),
        ...
        (I.createString = function (t, e, i) {
          for (
            var r = new ArrayBuffer(2 * i), o = new Uint16Array(r), n = 0;
            n < i;
            n++
          )
            o[n] = t.getUint8(e + n);
        ...
        (D.prototype._$Ur = function (t) {
          ...
          for (var e = t._$v2(), i = this._$Ob.length - 1; i >= 0; --i) {
            ...
            if (
              (r == w._$ds && (r = t.getParamIndex(this._$Ob[i].getParamID())),
              t._$Xb(r))
            )
              return !0;
          }
        ...
        (D.prototype._$Q2 = function (t, e) {
          for (
            var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, a = 0;
            a < o;
            a++
          ) {
            var _ = this._$Ob[a];
            if (
              ((i = _.getParamIndex(n)) == w._$ds &&
                ((i = t.getParamIndex(_.getParamID())), _._$Pb(i, n)),
              i < 0)
            )
        ...
        (R.prototype.transform = function (t, e, i) {
          ...
          switch (this._$hi) {
            ...
            case R._$go | R._$fo:
              for (
                r = this._$7, o = this._$H, s = this._$f, a = this._$g;
                --i >= 0;
            ...
            case R._$go | R._$gb:
              for (
                o = this._$H, n = this._$k, s = this._$f, _ = this._$w;
                --i >= 0;
            ...
            case R._$fo | R._$gb:
              for (
                r = this._$7, n = this._$k, a = this._$g, _ = this._$w;
                --i >= 0;

              )
                (e[l++] = r * t[h++] + n), (e[l++] = a * t[h++] + _);
              return;
            case R._$fo:
              for (r = this._$7, a = this._$g; --i >= 0; )
                (e[l++] = r * t[h++]), (e[l++] = a * t[h++]);
              return;
            case R._$gb:
              for (n = this._$k, _ = this._$w; --i >= 0; )
                (e[l++] = t[h++] + n), (e[l++] = t[h++] + _);
              return;
          ...
          0 == this._$H && 0 == this._$f
            ? 1 == this._$7 && 1 == this._$g
              ? 0 == this._$k && 0 == this._$w
                ? ((this._$hi = R.STATE_IDENTITY), (this._$Z = R._$pS))
                : ((this._$hi = R._$gb), (this._$Z = R._$hb))
              : 0 == this._$k && 0 == this._$w
              ? ((this._$hi = R._$fo), (this._$Z = R._$kS))
              : ((this._$hi = R._$fo | R._$gb), (this._$Z = R._$kS))
            : 0 == this._$7 && 0 == this._$g
            ? 0 == this._$k && 0 == this._$w
              ? ((this._$hi = R._$go), (this._$Z = R._$kS))
              : ((this._$hi = R._$go | R._$gb), (this._$Z = R._$kS))
            : 0 == this._$k && 0 == this._$w
            ? ((this._$hi = R._$go | R._$fo), (this._$Z = R._$kS))
              ...
              if ("#" != n)
                if ("$" != n) {
                  if (
                    ...
                    if (l >= 0) {
                      var s = new N();
                      I.startsWith(t, h, F._$cs)
                        ? ((s._$RP = N._$hs),
                          (s._$4P = new String(t, h, l - h)))
                        : I.startsWith(t, h, F._$ar)
                        ? ((s._$4P = new String(t, h + 7, l - h - 7)),
                          I.startsWith(t, h + 7, "ANCHOR_X")
                            ? (s._$RP = N._$xs)
                            : I.startsWith(t, h + 7, "ANCHOR_Y")
                            ? (s._$RP = N._$us)
                            : I.startsWith(t, h + 7, "SCALE_X")
                            ? (s._$RP = N._$qs)
                            : I.startsWith(t, h + 7, "SCALE_Y")
                            ? (s._$RP = N._$Ys)
                            : I.startsWith(t, h + 7, "X")
                            ? (s._$RP = N._$ws)
                            : I.startsWith(t, h + 7, "Y") && (s._$RP = N._$Ns))
                        : ((s._$RP = N._$Fr),
                          (s._$4P = new String(t, h, l - h))),
                        e.motions.push(s);
                      var a = 0;
          ...
          for (
            ...
            if (_._$RP == N._$hs) {
              ...
              var u = t.getParamFloat(l),
                ...
                c =
                  u +
                  (p + (_._$I0[n + 1 >= h ? h - 1 : n + 1] - p) * s - u) * i;
              t.setParamFloat(l, c);
            }
          }
          n >= this._$yT &&
        ...
        (U.prototype.update = function () {
          ...
          for (var t = this._$_2.length, e = 0; e < t; e++)
            this._$_2[e] != this._$vr[e] &&
              ((this._$Js[e] = U._$ZS), (this._$vr[e] = this._$_2[e]));
          ...
          for (e = 0; e < n; e++)
            (this._$Ws[e] = U._$V2), (this._$Vs[e] = U._$V2);
        ...
        (k.prototype._$7T = function (t) {
          ...
          switch (this._$_L) {
            case STATE_CLOSING:
              (r = (i - this._$bb) / this._$Dr) >= 1 &&
                ((r = 1), (this._$_L = V.STATE_CLOSED), (this._$bb = i)),
                (e = 1 - r);
              break;
            case STATE_CLOSED:
              (r = (i - this._$bb) / this._$Cb) >= 1 &&
                ((this._$_L = V.STATE_OPENING), (this._$bb = i)),
                (e = 0);
              break;
            case STATE_OPENING:
              (r = (i - this._$bb) / this._$mr) >= 1 &&
                ((r = 1),
      ...
      function z() {
        i ||
          (x.prototype.constructor.call(this),
          (this._$GS = null),
          (this._$Y0 = null));
      }
      function H(t) {
      ...
      function ct() {
        i || ((this.motions = null), (this._$eb = !1), (this.motions = []));
      }
      function ft() {
        (this._$w0 = null),
          (this._$AT = !0),
      ...
      (V.STATE_FIRST = "STATE_FIRST"),
        ...
        (X._$cr = function (t, e) {
          return (
            null == t || t._$yL() < e.length
              ? ((t = X._$9r(2 * e.length)).put(e), t._$oT(0))
        ...
        (X._$mb = function (t, e) {
          return (
            null == t || t._$yL() < e.length
              ? ((t = X._$vb(2 * e.length)).put(e), t._$oT(0))
              : (t.clear(), t.put(e), t._$oT(0)),
            t
          );
        }),
        ...
        (z.prototype._$Nr = function (t, e) {
          ...
          if (this._$GS._$Ur(t)) {
            ...
            if ((this._$GS._$zr(n, s, o), o <= 0)) {
              ...
              for (var tt = [], et = 0; et < j; et++) tt[et] = this._$Y0[n[et]];
              var it = 0,
                rt = 0,
                ot = 0,
                nt = 0,
        ...
        (z.prototype._$2b = function (t, e) {
          ...
          if ((i._$hS(!0), this._$32())) {
            ...
            if (
              (i._$8r == x._$ur && (i._$8r = t.getBaseDataIndex(r)), i._$8r < 0)
            )
              at._$so && a._$li("_$L _$0P _$G :: %s", r), i._$hS(!1);
            else {
              ...
              if (null != o) {
                ...
                (_[0] = 0),
                  (_[1] = -0.1),
                  n._$GT().getType() == x._$c2 ? (_[1] = -10) : (_[1] = -0.1);
                var h = z._$0o;
        ...
        (z.prototype._$nb = function (t, e, i, r, o, n, s) {
          ...
          for (
            var a,
              ...
              $ = Math.sin(St._$bS * l._$qT),
              u = Math.cos(St._$bS * l._$qT),
              p = h.getTotalScale(),
              c = l.reflectX ? -1 : 1,
              f = l.reflectY ? -1 : 1,
              g = u * p * c,
              ...
              if ("#" != n)
                if ("$" != n) {
                  if (
                    ...
                    if (u >= 0) {
                      var a = new N();
                      I.startsWith(t, $, J._$cs)
                        ? ((a._$RP = N._$hs),
                          (a._$4P = I.createString(t, $, u - $)))
                        : I.startsWith(t, $, J._$ar)
                        ? ((a._$4P = I.createString(t, $ + 7, u - $ - 7)),
                          I.startsWith(t, $ + 7, "ANCHOR_X")
                            ? (a._$RP = N._$xs)
                            : I.startsWith(t, $ + 7, "ANCHOR_Y")
                            ? (a._$RP = N._$us)
                            : I.startsWith(t, $ + 7, "SCALE_X")
                            ? (a._$RP = N._$qs)
                            : I.startsWith(t, $ + 7, "SCALE_Y")
                            ? (a._$RP = N._$Ys)
                            : I.startsWith(t, $ + 7, "X")
                            ? (a._$RP = N._$ws)
                            : I.startsWith(t, $ + 7, "Y") && (a._$RP = N._$Ns))
                        : ((a._$RP = N._$Fr),
                          (a._$4P = I.createString(t, $, u - $))),
                        e.motions.push(a);
                      var _ = 0,
          ...
          for (
            ...
            if (
              ...
              if (!m) {
                ...
                (p -= 0.5 * ((f = 0.5 * (M + A)) + (y = 0.5 * (M - A)))),
                  (c -= 0.5 * ((g = 0.5 * (x + w)) + (d = 0.5 * (x - w))));
              }
              if (-2 < S && S < 3 && -2 < L && L < 3)
                if (S <= 0)
                  if (L <= 0) {
                    var I = s[2 * (0 + 0 * E)],
                      ...
                      C = p - 2 * f - 2 * y,
                      N = c - 2 * g - 2 * d;
                    (B = 0.5 * (S - -2)) + (G = 0.5 * (L - -2)) <= 1
                      ? ((i[T] = C + (R - C) * B + (O - C) * G),
                        (i[T + 1] = N + (F - N) * B + (b - N) * G))
                      : ((i[T] = I + (O - I) * (1 - B) + (R - I) * (1 - G)),
          ...
          try {
            ...
            for (
              ...
              if (
                ...
                var et = _._$e0;
                if (
                  ((et.gl_cacheImage = et.gl_cacheImage || {}),
                  !et.gl_cacheImage[v])
                ) {
                ...
                at.IGNORE_CLIP ||
                  ot.clip(u, y, n, k, O, b, R, F, C, N, M, x, A, w, I, D),
        ...
        (ot.clip = function (t, e, i, r, o, n, s, a, _, h, l, $, u, p, c, f) {
          i > 0.02
            ? ot.expandClip(t, e, i, r, l, $, u, p, c, f)
            : ot.clipWithTransform(t, null, o, n, s, a, _, h);
        }),
        (ot.expandClip = function (t, e, i, r, o, n, s, a, _, h) {
          ...
          return (
            null != e._$P2(N) &&
            (ot.clipWithTransform(t, N, E, M, x, A, w, I, D, O, F, C, b, R), !0)
          );
        }),
        ...
        (_t._$r2 = function (t) {
          return t < 0 ? 0 : t > 1 ? 1 : 0.5 - 0.5 * Math.cos(t * St.PI_F);
        }),
        (ht._$fr = -1),
            ...
            case B._$Qs:
              for (o = this._$d0 - 1; o >= 0; --o) {
                ...
                (e._$Cr[s] = a),
                  ...
                  (e._$Cr[s + 4] = 0),
                  r &&
                    ((e._$hr[s] = a), (e._$hr[s + 1] = _), (e._$hr[s + 4] = 0));
              }
          }
          return e;
        }),
        (lt.prototype._$Nr = function (t, e) {
          ...
          if (
            ...
            this._$GS._$Ur(t) &&
              (W.prototype._$Nr.call(this, t, i), !i._$IS[0]))
          ) {
            var r = lt._$gT;
            (r[0] = !1),
              v._$Vr(
        ...
        (lt.prototype.draw = function (t, e, i) {
          if (
            (this != i._$GT() && console.log("### assert!! ### "), !i._$IS[0])
          ) {
            var r = i,
              o = this._$LP;
            o < 0 && (o = 1);
        ...
        (dt._$cr = function (t, e) {
          return (
            null == t || t._$yL() < e.length
              ? ((t = dt._$9r(2 * e.length)).put(e), t._$oT(0))
              : (t.clear(), t.put(e), t._$oT(0)),
            t
          );
        }),
        (dt._$mb = function (t, e) {
          return (
            null == t || t._$yL() < e.length
              ? ((t = dt._$vb(2 * e.length)).put(e), t._$oT(0))
              : (t.clear(), t.put(e), t._$oT(0)),
            t
          );
        }),
        ...
        (dt.prototype.compileShader = function (t, e) {
          ...
          if (
            ...
            return (
              a._$Ji("_$L0 to compile shader : " + n), i.deleteShader(o), null
            );
          }
          return o;
        }),
        ...
        (dt.prototype.createFramebuffer = function () {
          ...
          return (
            ...
            { framebuffer: i, renderbuffer: r, texture: at.fTexture[this.glno] }
          );
        }),
      ...
      (Pt.prototype._$bT = function () {
        ...
        (Et.setup = function () {
          ...
          function i(t, e) {
            for (
              var i = t.substring(e).split(/[ _,;\.]/), r = 0, o = 0;
              o <= 2 && !isNaN(i[o]);
              o++
            ) {
              var n = parseInt(i[o]);
          ...
          if ((t = e.indexOf("iPhone OS ")) >= 0)
            ...
            (t = e.indexOf("Android")) >= 0
              ? ((r.os = "Android"),
                (r._isAndroid = !0),
                (r.version = i(e, t + "Android ".length)))
              : ((r.os = "-"), (r.version = -1));
        }),
        at.init();
      i = !1;
  ...
  81: function (t, e, i) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.L2DBaseModel =
        e.L2DExpressionMotion =
        e.L2DExpressionParam =
        e.L2DEyeBlink =
        e.EYE_STATE =
        e.L2DMatrix44 =
        e.L2DModelMatrix =
    ...
    var n = 0;
    function s() {
      r.AMotion.prototype.constructor.call(this), (this.paramList = []);
    }
    function a() {
      ...
      (s.prototype.updateParamExe = function (t, e, i, r) {
        for (var o = this.paramList.length - 1; o >= 0; --o) {
          ...
          n.type == s.TYPE_ADD
            ...
            : n.type == s.TYPE_SET && t.setParamFloat(n.id, n.value, i);
        }
      }),
      ...
      (_.prototype.updateParam = function (t) {
        ...
        switch (this.eyeState) {
          case h.STATE_CLOSING:
            (o = (i - this.stateStartTime) / this.closingMotionMsec) >= 1 &&
              ((o = 1),
            ...
            break;
          case h.STATE_CLOSED:
            (o = (i - this.stateStartTime) / this.closedMotionMsec) >= 1 &&
              ((this.eyeState = h.STATE_OPENING), (this.stateStartTime = i)),
              (e = 0);
            break;
          case h.STATE_OPENING:
            (o = (i - this.stateStartTime) / this.openingMotionMsec) >= 1 &&
              ((o = 1),
          ...
          case h.STATE_INTERVAL:
            this.nextBlinkTime < i &&
              ((this.eyeState = h.STATE_CLOSING), (this.stateStartTime = i)),
              (e = 1);
            break;
          case h.STATE_FIRST:
          default:
    ...
    (h.STATE_FIRST = "STATE_FIRST"),
      ...
      (p.load = function (t) {
        for (
          var e = new p(),
            i = d.getPlatformManager().jsonParseFromBytes(t).physics_hair,
            o = i.length,
            n = 0;
          n < o;
          n++
      ...
      (p.prototype.updateParam = function (t) {
        for (
          var e = r.UtSystem.getUserTimeMSec() - this.startTimeMSec, i = 0;
      ...
      (c.load = function (t) {
        for (
          var e = new c(),
            i = d.getPlatformManager().jsonParseFromBytes(t).parts_visible,
            r = i.length,
            o = 0;
          o < r;
          o++
        ) {
          for (var n = i[o].group, s = n.length, a = [], _ = 0; _ < s; _++) {
            var h = n[_],
              l = new f(h.id);
      ...
      (c.prototype.normalizePartsOpacityGroup = function (t, e, i) {
        for (var r = -1, o = 1, n = 0; n < e.length; n++) {
          ...
          if (!(s < 0) && 0 != t.getParamFloat(a)) {
            if (r >= 0) break;
            (r = n), (o = t.getPartsOpacity(s)), (o += i / 0.5) > 1 && (o = 1);
          }
        }
        r < 0 && ((r = 0), (o = 1));
        for (n = 0; n < e.length; n++) {
          if (!((s = e[n].partsIndex) < 0))
            if (r == n) t.setPartsOpacity(s, o);
              ...
              (1 -
                (_ = o < 0.5 ? (-0.5 * o) / 0.5 + 1 : (0.5 * (1 - o)) / 0.5)) *
                (1 - o) >
                0.15 && (_ = 1 - 0.15 / (1 - o)),
                h > _ && (h = _),
        ...
        if (0 != this.lastTimeSec) {
          ...
          if (!(Math.abs(n) <= this.EPSILON && Math.abs(s) <= this.EPSILON)) {
            ...
            ($ < -o || $ > o) && ((h *= o / $), (l *= o / $), ($ = o)),
              (this.faceVX += h),
              (this.faceVY += l);
            var u = 0.5 * (Math.sqrt(o * o + 16 * o * a - 8 * o * a) - o),
              p = Math.sqrt(
  ...
  83: function (t, e, i) {
    ...
    (e.createElement = function () {
      ...
      (i.id = r.config.name.div),
        ...
        i.style.setProperty(
          r.config.display.position,
          r.config.display.hOffset + "px",
        ),
      ...
      _.setAttribute("id", r.config.name.canvas),
        _.setAttribute(
          "width",
          r.config.display.width * r.config.display.superSample,
        ),
        _.setAttribute(
          "height",
          r.config.display.height * r.config.display.superSample,
        ),
  ...
  86: function (t, e, i) {
    ...
    var n = (function (t) {
      function e(t) {
        ...
        return (i.output = t), (i.emitters = []), (i.variables = []), i;
      }
      return (
        (function (t, e) {
        ...
        r(e, [
          {
            key: "registerEmitter",
            value: function (t, e) {
              this.emitters.push({ name: t.toLowerCase(), func: e });
            },
          },
          {
            key: "registerVariable",
            value: function (t, e) {
              this.variables.push({ name: t.toLowerCase(), func: e });
            },
          },
          {
            key: "matchEmitter",
      ...
      everyEmitter: function (t) {
        return function (e, i) {
          ...
          var n = (function (t) {
            ...
            return (
              e.test(o)
                ? ((e.lastIndex = 0), (n = 1e3 * parseInt(e.exec(o)[1])))
                : i.test(o)
                ? ((i.lastIndex = 0), (n = parseInt(i.exec(o)[1])))
                : r.test(o) &&
                  ((r.lastIndex = 0), (n = 60 * parseInt(r.exec(o)[1]) * 1e3)),
              n
            );
          })(r);
          if (n) {
  ...
  93: function (t, e, i) {
    ...
    (a.prototype.createModel = function () {
      ...
      (a.prototype.tapEvent = function (t, e) {
        ...
        for (var i = 0; i < this.models.length; i++)
          this.models[i].hitTest(s.cDefine.HIT_AREA_HEAD, t, e)
            ? (this.eventemitter.emit("tapface"),
              s.cDefine.DEBUG_LOG && console.log("Tap face."),
              this.models[i].setRandomExpression())
            : this.models[i].hitTest(s.cDefine.HIT_AREA_BODY, t, e) &&
    ...
    (_.prototype = new r.L2DBaseModel()),
      ...
      (_.prototype.update = function () {
        if (null != this.live2DModel) {
          var t =
            2 *
            ((a.UtSystem.getUserTimeMSec() - this.startTimeMSec) / 1e3) *
            Math.PI;
      ...
      (_.prototype.startMotion = function (t, e, i) {
        ...
        if (null != r && "" != r) {
          ...
          var o,
            n = this;
          null == this.motions[t]
            ? this.loadMotion(t, this.modelHomeDir + r, function (r) {
